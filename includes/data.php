    ...
    return [
        ...
        'resources' => [
            [
                ...
                'overview' => 'Guide complet pour organiser une visite pédagogique de ferme, depuis la préparation avec le groupe jusqu’au débriefing après la sortie.',
                'for' => 'Écoles, associations jeunesse, centres culturels et familles.',
                'steps' => [
                    'Définir l’objectif pédagogique (alimentation, biodiversité, métiers, saisonnalité).',
                    'Contacter la ferme au moins 3 à 6 semaines à l’avance et préciser l’âge du groupe.',
                    'Préparer les participants avec un vocabulaire de base (filière, élevage, rotation, circuit court).',
                    'Prévoir logistique et sécurité : transport, autorisations, tenue adaptée, allergies.',
                    'Construire un retour en classe ou en famille (quiz, recette, affiche, podcast).',
                ],
                'checklist' => [
                    'Nombre de participants et encadrants confirmé.',
                    'Heure d’arrivée et durée de visite validées.',
                    'Consignes de sécurité reçues et communiquées.',
                    'Activité de suivi prévue après la visite.',
                ],
            ],
            [
