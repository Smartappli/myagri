...
$profiles = [
    'sols' => [
        ...
        'related' => ['fertilite-du-sol', 'matiere-organique', 'humus', 'erosion-des-sols', 'couvert-vegetal', 'rotation'],
    ],
    'elevage' => [
        ...
        'related' => ['prairie-permanente', 'autonomie-fourragere', 'paturage-tournant', 'densite-de-chargement', 'elevage-extensif', 'polyculture-elevage'],
    ],
    'filiere' => [
        ...
        'related' => ['filiere', 'circuit-court', 'valeur-ajoutee', 'tracabilite', 'aop-igp', 'prix-remunerateur', 'saisonnalite'],
    ],
    'transition' => [
        ...
        'related' => ['agroecologie', 'transition-agroecologique', 'resilience', 'agriculture-biologique', 'agriculture-de-precision', 'diversification'],
    ],
    'climat' => [
        ...
        'related' => ['bilan-carbone', 'sequestration-carbone', 'stress-hydrique', 'irrigation-raisonnee', 'methanisation', 'haie-vive'],
    ],
    'territoire' => [
        ...
        'related' => ['pac', 'zero-artificialisation-nette-zan', 'souverainete-alimentaire', 'wallesmart', 'filiere', 'tracabilite'],
    ],
];
